...
cargo +1.58.0 test --package 'yash-semantics' -- $quiet
cargo +1.56.0 test --package 'yash-syntax' -- $quiet
cargo +1.56.0 test --package 'yash-syntax' --features annotate-snippets -- $quiet
cargo +1.58.0 test --package 'yash' -- $quiet

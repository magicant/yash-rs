...
use crate::system::{Fcntl, SharedSystem, Signals, Write};
...
impl<T: Fcntl + Signals + Write, U: Input> Input for Reporter<'_, '_, SharedSystem<T>, U> {
...
async fn report<T: Fcntl + Signals + Write>(env: &mut Env<SharedSystem<T>>) {

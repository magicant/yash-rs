...
mod tests {
    ...
    fn open_creating_non_existing_file() {
        ...
        system.write(Fd(3), &[42, 123]).now_or_never().unwrap().unwrap();
    ...
    fn open_existing_file() {
        ...
        let fd = system
            ...
            .unwrap()
            .unwrap();
        system.write(fd, &[75, 96, 133]).now_or_never().unwrap().unwrap();
    ...
    fn open_truncating() {
        ...
        let fd = system
            ...
            .unwrap()
            .unwrap();
        system.write(fd, &[1, 2, 3]).now_or_never().unwrap().unwrap();
    ...
    fn open_appending() {
        ...
        let result = system
            ...
            .unwrap();
        assert_eq!(result, Ok(Fd(4)));
        system.write(Fd(4), &[4, 5, 6]).now_or_never().unwrap().unwrap();
    ...
    fn open_default_working_directory() {
        ...
        let writer = system
            ...
            .now_or_never()
            .unwrap();
        system.write(writer.unwrap(), &[1, 2, 3, 42]).now_or_never().unwrap().unwrap();
    ...
    fn open_tmpfile() {
        ...
        system.write(fd, &[42, 17, 75]).now_or_never().unwrap().unwrap();

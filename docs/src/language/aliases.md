...
(Since 3.3.1) When the [`portable` option](../environment/options.md#portable) is set, the [`alias` built-in](../builtins/alias.md) refuses to define an alias with other characters in its name, reporting an error instead.

...
test_o 'shell invocation accepts - alone under the portable option' -o portable -
echo $#
__IN__
0
__OUT__

test_o 'shell invocation accepts - among operands under the portable option' -o portable -s x - y
echo "$@"
__IN__
x - y
__OUT__
